...
public class FunctionPlotter1D {
	...
	public void plot(PApplet app) {
		...
		if (this.plot == null) {
			...
			this.plot.setTitleText("Power Equation");
			this.plot.getXAxis().setAxisLabelText("t (seconds)");
			this.plot.getYAxis().setAxisLabelText("f(t) (watts)");
		...
		firstLayer.setPointSize(2f);
//		firstLayer.setPointColor(255);
